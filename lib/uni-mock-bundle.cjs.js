    ...
    var server = http__namespace.createServer(function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            if (isMock(req.url, config['suffix'])) {
                ...
                url_1 = path__namespace.join(config["path"], config['suffix'] === "/" ? _originUrl : _originUrl.split(config['suffix'])[1]);
...
fileCheck(configPath).then(function (newConfig) {
    var incomingConfig = require(configPath);
    var _defaultConfig = merge(defaultConfig, newConfig ? incomingConfig : {});
